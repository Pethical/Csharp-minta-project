...
namespace Pethical.Framework.Modularization
{
    ...
    public sealed class PriorityAttribute : Attribute
    {
        ...
        public PriorityAttribute(int priority, Type RequiredType) : this(priority, new Type[] { RequiredType })
        {
            
        }

        public PriorityAttribute(int priority, params Type[] RequiredTypes) : this(priority)
        {
            this.RequiredTypes.AddRange(RequiredTypes);
        }
